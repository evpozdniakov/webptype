var evWebtype={
	...
	run: function(text,opts){
		...
		evWebtype.nonbsp_status = opts.nonbsp_status;
	...
	parseTextAddition: function(){
        ...
        // числовой промежуток
        re = /(^|[^0-9-])([0-9]+)-([0-9]+)($|[^0-9-])/gi; this.text = this.text.replace(re, "$1$2&ndash;$3$4");
	},
	parseBr: function(){
